...
ParticipantWindow::ParticipantWindow(RepoQuestions &repo, RepoParticipants& repoParticipants, Participant& p, QWidget *parent): repo{repo}, repoParticipants{repoParticipants}, p{p}, QWidget(parent) {
...
void ParticipantWindow::answerQuestion() {
    ...
    try{
        ...
        QMessageBox::information(this, "Correct answer!", "Correct answer! Keep up the great work");
        this->scoreLabel->setText(QString::fromStdString(to_string(this->p.getScore())));
        ...
        this->answerLineEdit->clear();
        QMessageBox::critical(this, "Wrong answer!", "Wrong answer! Zero points received!");
        return;
    }
}
